...
// This is the main function to use to create a new websocket connection
// Use this function if the Type is set to "managed"
// This function is experimental and may change in the future
//
// The managed method is managed by Pine's runtime for efficiency
// Each connection is linked to a channel and a client
// You can move clients to different channels for example in a chat application
// Instead of managing all new connections manually, you can use the channel ID of
// the connection to move the client to a different channel
